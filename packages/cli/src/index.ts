...
/**
 * @minions-invoices/cli — CLI for Minions Invoices
 *
...
import { customTypes } from '@minions-invoices/sdk';
...
program
    .name('invoices')
    .description('Invoice generation, payment tracking, due dates, and billing status for agency clients')
    .version('0.1.0');
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Invoices'));
        console.log(chalk.dim('Invoice generation, payment tracking, due dates, and billing status for agency clients'));
        console.log('');
        console.log(`  SDK:      ${chalk.cyan('@minions-invoices/sdk')}`);
        console.log(`  CLI:      ${chalk.cyan('@minions-invoices/cli')}`);
        console.log(`  Python:   ${chalk.cyan('minions-invoices')}`);
