# Manual Setup Steps for Minions Invoices
...
Go to **GitHub → mxn2020/minions-invoices → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-invoices` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-invoices-web`
- **GitHub repo**: `mxn2020/minions-invoices`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `invoices.minions.wtf`

### Documentation
- **Netlify site name**: `minions-invoices-docs`
- **GitHub repo**: `mxn2020/minions-invoices`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `invoices.minions.help`

### Blog
- **Netlify site name**: `minions-invoices-blog`
- **GitHub repo**: `mxn2020/minions-invoices`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `invoices.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `invoices.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `invoices.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `invoices.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-invoices/sdk`](https://www.npmjs.com/package/@minions-invoices/sdk)
- CLI: [`@minions-invoices/cli`](https://www.npmjs.com/package/@minions-invoices/cli)
...
Your package: [`minions-invoices`](https://pypi.org/project/minions-invoices/)
...
| Item | Value |
|------|-------|
| Project | `minions-invoices` |
| SDK (npm) | `@minions-invoices/sdk` |
| CLI (npm) | `@minions-invoices/cli` |
| Python (PyPI) | `minions-invoices` |
| GitHub | `github.com/mxn2020/minions-invoices` |
| Docs domain | `invoices.minions.help` |
| Blog domain | `invoices.minions.blog` |
| App domain | `invoices.minions.wtf` |
